<template>
  <v-row>
    <v-col cols="6">
      ...
      <p>
        <small class="text--secondary">RAZÓN SOCIAL</small><br>
        {{ item.razon_social }}
      </p>
      <p>
    ...
    <v-col cols="6">
      ...
      <p>
        <small class="text--secondary">TELÉFONOS</small><br>
        {{ item.telefonos }}
      </p>
      <p>
...
<script>
import EquiposMedicos from '@/components/tables/EquiposMedicosTable'
export default {
  name: 'ClientDetails',
  components: {
    EquiposMedicos
